...
![Description](/assets/images/projects/crowdnav/traj_samples.png)
<center><h6>Comparing trajectories of the robot and a sample pedestrian. 196 samples were generated, each simulating 25 timesteps of the trajectory. </h6></center>
...
*  Have the BRNE algorithm running onboard the Orin Nano or another mounted device. This could be done with CUDA.
...
*  Adjust the robot's sampling. Currently, the robot is modeled as a simple differential drive system and the samples are generated over a space of linear velocity and angular velocity. 
