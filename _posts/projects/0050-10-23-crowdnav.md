...
*  Adjust the robot's sampling. Currently, the robot is modeled as a simple differential drive system and the samples are generated over a space of linear velocity and angular velocity. First, the Unitree robot is omnidirectional, and the controls can consist of $v_x$, $v_y$, and $v_\theta$. This may make the robot more agile. 
